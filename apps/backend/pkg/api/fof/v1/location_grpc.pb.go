...
func (c *locationServiceClient) GetClearedArea(ctx context.Context, in *GetClearedAreaRequest, opts ...grpc.CallOption) (*GetClearedAreaResponse, error) {
	out := new(GetClearedAreaResponse)
	err := c.cc.Invoke(ctx, LocationService_GetClearedArea_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _LocationService_GetClearedArea_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetClearedAreaRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LocationServiceServer).GetClearedArea(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LocationService_GetClearedArea_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LocationServiceServer).GetClearedArea(ctx, req.(*GetClearedAreaRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var LocationService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "fof.v1.LocationService",
	...
	Metadata: "fof/v1/location.proto",
}
